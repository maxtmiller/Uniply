...
var courses = [
    ...
    Course(title: "University Application", subtitle: "1 sections - 5 minutes", text: "This section will explain about the information needed to apply to universities...", image: "Application", color: .blue),
]
